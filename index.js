...
<th scope="col">${document.getElementsByClassName("ascii_row_pattern_hex").innerText}</th>
<th scope="col">${document.getElementsByClassName("ascii_row_pattern_hex_with_data_structure").innerText}</th>
<th scope="col">#define ASCII88PATTERN_${$('#val_index_text').val()} ${document.getElementsByClassName("ascii_row_pattern_hex_with_data_structure").innerText}</th>
<th scope="col">${document.getElementsByClassName("obj_all_data_to_save").innerText}</th>
</tr>`;
            }
        }
        checkFlag();
